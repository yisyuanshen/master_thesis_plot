...
robot_file_paths = 'exp_data_final/0612_force_h24.csv'
vicon_file_paths = 'exp_data_final/0612_force_h24_vicon.csv'
...
lines = [axs[0, 0].lines[0], Patch(facecolor=state_colors[3], edgecolor='none', alpha=0.3, label='Foot Tip (Point G)'),
         axs[0, 0].lines[1], axs[0, 0].lines[2]]
...
print(f'\nZ = {np.average(rmse_results['Z']+rmse_results['Z']):.2f}, X = {np.average(rmse_results['X']):.2f}')
