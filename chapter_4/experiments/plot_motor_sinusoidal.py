...
robot_file_paths_old = 'exp_data_final/0320_imp_wave_old.csv'
robot_file_paths_new = 'exp_data_final/0320_imp_wave_new.csv'
...
cmd_theta[0][0] = cmd_theta[0][2]
cmd_theta[0][1] = cmd_theta[0][2]
...
# Theta and Beta
ax = axs[0]
ax.plot(time_robot, DataLoader.low_pass_filter(np.rad2deg(cmd_theta[0]), 5), label=r'Command', color=colors[0], linestyle='-', linewidth=linewidth)
...
ax.set_ylim([0, 480])
ax.set_yticks(np.arange(0, 481, 120))
