...
robot_file_paths = 'exp_data/sim/sim_force_U.csv'
sim_force_file_paths = 'exp_data/sim/sim_force_U_force.csv'
...
time_sim = np.arange(loader.df_sim_force.shape[0]-1000) / sample_rate
time_robot = np.arange(loader.df_robot.shape[0]-1000) / sample_rate

loader.sim_force_x = loader.sim_force_x[:, 500:-500]
loader.sim_force_z = loader.sim_force_z[:, 500:-500]
loader.cmd_force_x = loader.cmd_force_x[:, 500:-500]
loader.cmd_force_z = loader.cmd_force_z[:, 500:-500]
loader.state_force_x = loader.state_force_x[:, 500:-500]
loader.state_force_z = loader.state_force_z[:, 500:-500]
# Plot Z
...
ax.set_ylim([45, 85])
ax.set_yticks(np.arange(45, 86, 10))
...
ax.set_ylim([25, 65])
ax.set_yticks(np.arange(25, 66, 10))
