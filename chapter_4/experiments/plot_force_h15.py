...
robot_file_paths = 'data/0612/0612_force_h15.csv'
vicon_file_paths = 'data/0612/force_h15.csv'
...
fig.legend(lines, labels, loc='lower center', fontsize=14, ncol=3, frameon=True, bbox_to_anchor=(0.5, 0))
