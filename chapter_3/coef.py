...
E_poly   = np.array([ np.polynomial.Polynomial(E_x_coef), np.polynomial.Polynomial(E_y_coef)])
...
G_poly   = np.array([ np.polynomial.Polynomial(G_x_coef), np.polynomial.Polynomial(G_y_coef)])
