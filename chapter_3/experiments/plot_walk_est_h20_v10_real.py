...
robot_file_paths = 'exp_data_final/0617_walk_h20_v10_open.csv'
vicon_file_paths = 'exp_data_final/0617_walk_h20_v10_open_vicon.csv'

start_idx = 14500
end_idx = 18500
loader.trigger_idx = 6282+818-787
...
# save
# plt.savefig('real_walk_est_h20_v10_result.pdf', format='pdf', bbox_inches='tight')
