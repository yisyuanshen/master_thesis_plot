...
robot_file_paths = 'exp_data_final/0617_trot_h20_v60_open.csv'
vicon_file_paths = 'exp_data_final/0617_trot_h20_v60_open_vicon.csv'

start_idx = 5130
end_idx = 6130
loader.trigger_idx = 5227
...
ax.set_ylim([-90, 45])
ax.set_yticks(np.arange(-90, 46, 45))
...
# save
# plt.savefig('real_trot_est_h20_v60_result.pdf', format='pdf', bbox_inches='tight')
