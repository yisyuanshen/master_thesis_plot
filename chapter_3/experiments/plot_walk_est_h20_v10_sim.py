...
robot_file_paths = 'exp_data_final/sim_walk_h20_v10_open.csv'
sim_force_file_paths = 'exp_data_final/sim_walk_h20_v10_open_force.csv'
...
# save
# plt.savefig('sim_walk_est_h20_v10_result.pdf', format='pdf', bbox_inches='tight')
