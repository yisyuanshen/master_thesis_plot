...
robot_file_paths = 'exp_data_final/0626_wlw_h16_v16_open.csv'
vicon_file_paths = 'exp_data_final/0626_wlw_h16_v16_open_vicon.csv'

start_idx = 10700
end_idx = 12700
loader.trigger_idx = 4360
...
# save
# plt.savefig('real_wlw_est_h16_v16_result.pdf', format='pdf', bbox_inches='tight')
