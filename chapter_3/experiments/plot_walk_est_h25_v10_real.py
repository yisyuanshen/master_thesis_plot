...
robot_file_paths = 'exp_data_final/0617_walk_h25_v10_open.csv'
vicon_file_paths = 'exp_data_final/0617_walk_h25_v10_open_vicon.csv'

start_idx = 15500
end_idx = 18500
loader.trigger_idx = 6160+19
...
for i in range(2):
    for j in range(2):
        ...
        axs[i, j].set_xticks(np.arange(0, 2.1, 1))
        axs[i, j].grid(True)
