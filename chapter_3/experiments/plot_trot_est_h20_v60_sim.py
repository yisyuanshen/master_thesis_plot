...
robot_file_paths = 'exp_data_final/sim_trot_h20_v60_open.csv'
sim_force_file_paths = 'exp_data_final/sim_trot_h20_v60_open_force.csv'
...
ax.set_ylim([-30, 15])
ax.set_yticks(np.arange(-30, 16, 15))
...
for i in range(2):
    for j in range(2):
        ...
        axs[i, j].set_xticks(np.arange(0, 61, 10)/100)
        axs[i, j].grid(True)
