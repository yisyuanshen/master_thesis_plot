...
robot_file_paths = 'exp_data_final/sim_walk_h20_v15_open.csv'
sim_force_file_paths = 'exp_data_final/sim_walk_h20_v15_open_force.csv'
...
for i in range(2):
    for j in range(2):
        ...
        axs[i, j].set_xticks(np.arange(0, 5, 1))
        axs[i, j].grid(True)
...
# save
# plt.savefig('sim_walk_est_h20_v15_result.pdf', format='pdf', bbox_inches='tight')
