...
robot_file_paths = 'exp_data_final/0626_wlw_h18_v12_open.csv'
vicon_file_paths = 'exp_data_final/0626_wlw_h18_v12_open_vicon.csv'
...
# save
# plt.savefig('real_wlw_est_h18_v12_result.pdf', format='pdf', bbox_inches='tight')
