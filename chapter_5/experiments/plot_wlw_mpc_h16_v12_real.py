...
robot_file_paths_o = 'exp_data_final/0626_wlw_h16_v12_open.csv'
vicon_file_paths_o = 'exp_data_final/0626_wlw_h16_v12_open_vicon.csv'

robot_file_paths_c = 'exp_data_final/0626_wlw_h16_v12_closed.csv'
vicon_file_paths_c = 'exp_data_final/0626_wlw_h16_v12_closed_vicon.csv'
...
if odom:
    ax.set_ylim([0.154, 0.166])
    ax.set_yticks(np.arange(154, 167, 6)/1000)
else:
...
fig.suptitle(r'\textbf{Real Robot Results (\#7)}', fontsize=22, y=0.98)
