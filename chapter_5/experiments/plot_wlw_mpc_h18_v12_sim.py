...
robot_file_paths_o = 'exp_data/sim/sim_wlw_h18_v12_open.csv'
sim_force_file_paths_o = 'exp_data/sim/sim_wlw_h18_v12_open_force.csv'

robot_file_paths_c = 'exp_data/sim/sim_wlw_h18_v12_closed.csv'
sim_force_file_paths_c = 'exp_data/sim/sim_wlw_h18_v12_closed_force.csv'
...
if odom:
    ax.set_ylim([0.155, 0.185])
    ax.set_yticks(np.arange(155, 186, 10)/1000)
else:
    ax.set_ylim([0.155, 0.185])
    ax.set_yticks(np.arange(155, 186, 10)/1000)
ax.set_ylabel(r'\textbf{Position (m)}', fontsize=16)
