...
robot_file_paths_o = 'exp_data_final/sim_wlw_h18_v12_open.csv'
sim_force_file_paths_o = 'exp_data_final/sim_wlw_h18_v12_open_force.csv'

robot_file_paths_c = 'exp_data_final/sim_wlw_h18_v12_closed.csv'
sim_force_file_paths_c = 'exp_data_final/sim_wlw_h18_v12_closed_force.csv'
...
if odom:
    ax.set_ylim([0.168, 0.192])
    ax.set_yticks(np.arange(168, 193, 12)/1000)
else:
    ax.set_ylim([0.172, 0.188])
    ax.set_yticks(np.arange(172, 189, 8)/1000)
ax.set_ylabel(r'\textbf{Position (m)}', fontsize=16)
...
ground_truth = {
    ...
    'Position Z':      np.full(length, 0.18),
