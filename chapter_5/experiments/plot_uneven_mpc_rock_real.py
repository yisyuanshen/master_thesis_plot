...
robot_file_paths_o = 'exp_data_final/0716_rock_open_1.csv'
robot_file_paths_c = 'exp_data_final/0716_rock_closed_1.csv'
...
ax.set_ylim([0.230, 0.270])
ax.set_yticks(np.arange(230, 271, 20)/1000)
ax.set_ylabel(r'\textbf{Position (m)}', fontsize=16)
...
ax.set_ylim([-0.2, 0.4])
ax.set_yticks(np.arange(-20, 41, 20)/100)
...
ax.set_ylim([-16, 8])
ax.set_yticks(np.arange(-16, 9, 8))
ax.set_ylabel(r'\textbf{Angle (deg)}', fontsize=16)
