...
robot_file_paths_o = 'exp_data/real/0617_walk_h20_v10_open.csv'
vicon_file_paths_o = 'exp_data/real/0617_walk_h20_v10_open_vicon.csv'

robot_file_paths_c = 'exp_data/real/0617_walk_h20_v10_closed.csv'
vicon_file_paths_c = 'exp_data/real/0617_walk_h20_v10_closed_vicon.csv'
...
if odom:
    ax.set_ylim([-50, 25])
    ax.set_yticks(np.arange(-50, 26, 25))
else:
    ax.set_ylim([-50, 25])
    ax.set_yticks(np.arange(-50, 26, 25))
