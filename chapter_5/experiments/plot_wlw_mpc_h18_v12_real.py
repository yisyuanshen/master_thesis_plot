...
robot_file_paths_o = 'exp_data_final/0626_wlw_h18_v12_open.csv'
vicon_file_paths_o = 'exp_data_final/0626_wlw_h18_v12_open_vicon.csv'

robot_file_paths_c = 'exp_data_final/0626_wlw_h18_v12_closed.csv'
vicon_file_paths_c = 'exp_data_final/0626_wlw_h18_v12_closed_vicon.csv'
...
if odom:
    ax.set_ylim([0.170, 0.185])
    ax.set_yticks(np.arange(170, 186, 5)/1000)
else:
    ax.set_ylim([0.168, 0.186])
    ax.set_yticks(np.arange(168, 187, 6)/1000)
ax.set_ylabel(r'\textbf{Position (m)}', fontsize=16)
