...
robot_file_paths_o = 'exp_data/real/0618_wlw_h18_v12_open.csv'
vicon_file_paths_o = 'exp_data/real/0618_wlw_h18_v12_open_vicon.csv'

robot_file_paths_c = 'exp_data/real/0618_wlw_h18_v12_closed.csv'
vicon_file_paths_c = 'exp_data/real/0618_wlw_h18_v12_closed_vicon.csv'
...
if odom:
    ax.set_ylim([0.160, 0.190])
    ax.set_yticks(np.arange(160, 191, 10)/1000)
else:
    ax.set_ylim([0.160, 0.190])
    ax.set_yticks(np.arange(160, 191, 10)/1000)
ax.set_ylabel(r'\textbf{Position (m)}', fontsize=16)
