...
robot_file_paths_o = 'exp_data_final/0626_wlw_h16_v16_open.csv'
vicon_file_paths_o = 'exp_data_final/0626_wlw_h16_v16_open_vicon.csv'

robot_file_paths_c = 'exp_data_final/0626_wlw_h16_v16_closed.csv'
vicon_file_paths_c = 'exp_data_final/0626_wlw_h16_v16_closed_vicon.csv'
...
if odom:
    ...
    ax.set_yticks(np.arange(-7, 8, 7)/100)
else:
    ax.set_ylim([-0.07, 0.07])
    ax.set_yticks(np.arange(-7, 8, 7)/100)
ax.set_ylabel(r'\textbf{Velocity (m/s)}', fontsize=16)
...
if odom:
    ax.set_ylim([-2.5, 5])
    ax.set_yticks(np.arange(-25, 51, 25)/10)
else:
    ax.set_ylim([-4, 4])
