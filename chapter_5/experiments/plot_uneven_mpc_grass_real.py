...
robot_file_paths_o = 'exp_data_final/0716_grass_open.csv'
robot_file_paths_c = 'exp_data_final/0716_grass_closed_1.csv'
...
ax.set_yticks(np.arange(230, 261, 10)/1000)
ax.set_ylabel(r'\textbf{Position (m)}', fontsize=16)
...
ax.set_yticks(np.arange(-40, 21, 20)/100)
ax.set_ylabel(r'\textbf{Velocity (m/s)}', fontsize=16)
