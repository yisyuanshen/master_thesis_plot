...
robot_file_paths_o = 'exp_data_final/0716_hole_open_1.csv'
robot_file_paths_c = 'exp_data_final/0716_hole_closed_1.csv'
...
ax.set_ylim([0.150, 0.180])
ax.set_yticks(np.arange(150, 181, 10)/1000)
ax.set_ylabel(r'\textbf{Position (m)}', fontsize=16)
