...
robot_file_paths_o = 'exp_data_final/0625_walk_h20_v15_open.csv'
vicon_file_paths_o = 'exp_data_final/0625_walk_h20_v15_open_vicon.csv'

robot_file_paths_c = 'exp_data_final/0625_walk_h20_v15_closed.csv'
vicon_file_paths_c = 'exp_data_final/0625_walk_h20_v15_closed_vicon.csv'
...
for i in range(1000):
    target_vel_x.append(0.15/1000*i)
for i in range(13000):
    target_vel_x.append(0.15)
for i in range(1000):
    target_vel_x.append(0.15-0.15/1000*i)
for i in range(499):
    target_vel_x.append(0)


target_pos_x     = np.cumsum(target_vel_x) * dt
# print(target_pos_x[-1], loader_o.odom_pos_x.iloc[-1], loader_c.odom_pos_x.iloc[-1])
# print(target_pos_x[-1], loader_o.vicon_pos_x.iloc[-1], loader_c.vicon_pos_x.iloc[-1])
