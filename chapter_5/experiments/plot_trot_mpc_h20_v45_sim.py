...
robot_file_paths_o = 'data/trot_h20_v45_open.csv'
sim_force_file_paths_o = 'data/trot_h20_v45_open_force.csv'

robot_file_paths_c = 'data/trot_h20_v45_closed_1.csv'
sim_force_file_paths_c = 'data/trot_h20_v45_closed_force_1.csv'
...
for i in range(4):
    for j in range(2):
        ...
        axs[i, j].set_xticks(np.arange(0, 8, 2))
        axs[i, j].grid(True)
