...
robot_file_paths_o = 'exp_data_final/sim_walk_h20_v10_open.csv'
sim_force_file_paths_o = 'exp_data_final/sim_walk_h20_v10_open_force.csv'

robot_file_paths_c = 'exp_data_final/sim_walk_h20_v10_closed.csv'
...
fig.suptitle(r'\textbf{Simulation Results (\#1)}', fontsize=22, y=0.98)
# save
if odom:
