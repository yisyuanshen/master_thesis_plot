...
robot_file_paths_o = 'exp_data_final/sim_wlw_h16_v16_open.csv'
sim_force_file_paths_o = 'exp_data_final/sim_wlw_h16_v16_open_force.csv'

robot_file_paths_c = 'exp_data_final/sim_wlw_h16_v16_closed.csv'
sim_force_file_paths_c = 'exp_data_final/sim_wlw_h16_v16_closed_force.csv'
...
if odom:
    ...
    ax.set_ylim([0.153, 0.167])
    ax.set_yticks(np.arange(153, 168, 7)/1000)
ax.set_ylabel(r'\textbf{Position (m)}', fontsize=16)
...
ax.set_ylim([-11, 11])
ax.set_yticks(np.arange(-11, 12, 11))
...
ax.set_ylim([-13, 13])
ax.set_yticks(np.arange(-13, 14, 13))
ax.set_ylabel(r'\textbf{Rate (deg/s)}', fontsize=16)
...
for i in range(1000):
    target_vel_x.append(0.16/1000*i)
for i in range(13000):
    target_vel_x.append(0.16)
for i in range(1000):
    target_vel_x.append(0.16-0.16/1000*i)
for i in range(499):
    target_vel_x.append(0)
