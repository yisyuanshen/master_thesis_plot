...
robot_file_paths_o = 'exp_data/sim/sim_wlw_h16_v16_open.csv'
sim_force_file_paths_o = 'exp_data/sim/sim_wlw_h16_v16_open_force.csv'

robot_file_paths_c = 'exp_data/sim/sim_wlw_h16_v16_closed.csv'
sim_force_file_paths_c = 'exp_data/sim/sim_wlw_h16_v16_closed_force.csv'
...
if odom:
    ...
    ax.set_ylim([0.144, 0.168])
    ax.set_yticks(np.arange(144, 169, 8)/1000)
ax.set_ylabel(r'\textbf{Position (m)}', fontsize=16)
