...
robot_file_paths_o = 'exp_data_final/sim_walk_h20_v15_open.csv'
sim_force_file_paths_o = 'exp_data_final/sim_walk_h20_v15_open_force.csv'

robot_file_paths_c = 'exp_data_final/sim_walk_h20_v15_closed.csv'
sim_force_file_paths_c = 'exp_data_final/sim_walk_h20_v15_closed_force.csv'
...
ax.set_ylim([-2.5, 2.5])
ax.set_yticks(np.arange(-25, 30, 25)/10)
...
print(target_pos_x[-1], loader_o.sim_pos_x.iloc[-1], loader_c.sim_pos_x.iloc[-1])
ground_truth = {
