...
robot_file_paths_o = 'exp_data_final/0716_hole_open_w_1.csv'
robot_file_paths_c = 'exp_data_final/0716_hole_closed_w_1.csv'
...
ax.set_yticks(np.arange(-30, 16, 15)/100)
ax.set_ylabel(r'\textbf{Velocity (m/s)}', fontsize=16)
